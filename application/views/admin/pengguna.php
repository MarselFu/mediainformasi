                                ...
                                <?php else : ?>
                                    <?php foreach ($pengguna as $num => $p) : ?>
                                        <tr>
                                            ...
                                            <td><?= $p['username']; ?></td>
                                            <td>
                                                <a href="#" data-toggle="modal" data-target="#modalEdit" class="btn btn-sm btn-primary btn-edit" data-id="<?= $p['id']; ?>" data-nik="<?= $p['nama_instansi']; ?>" data-email="<?= $p['email']; ?>" data-alamat="<?= $p['alamat']; ?>" data-username="<?= $p['username']; ?>">EDIT</a>
                                            </td>
                                            <td>
...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; POS KC Banjar - <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/edit_pengguna'); ?>" method="post">
